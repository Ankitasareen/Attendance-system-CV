...
lbl3 = tk.Label(window, text="ATTENDANCE",width=20  ,fg="black"  ,bg="lightgreen"  ,height=2 ,font=('Times New Roman', 30, ' bold ')) 
...
takeImg = tk.Button(window, text="IMAGE CAPTURE BUTTON", command=TakeImages  ,bg="white"  ,fg="black"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
takeImg.place(x=245-x_cord, y=425-y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING BUTTON", command=TrainImages  ,bg="white"  ,fg="black"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
trainImg.place(x=645-x_cord, y=425-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,bg="white"  ,fg="black"  ,width=30  ,height=3, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
